...
VISPLOT_CATEGORIES = {
    ...
    "heatmap": ["heatmap", "heat map", "matrix plot", "correlation matrix",
                "confusion matrix", "clustermap", "color map"],
    "radar": ["radar chart", "spider chart", "star chart",
              "radial chart", "wind rose"],
    "map": ["choropleth", "geographic", "geospatial", "cartogram",
            "topographic"],
    "sankey": ["sankey", "alluvial", "parallel coordinates",
               "parallel categories"],

    # ── mathematical fine categories ──
    "math_function": ["function plot", "mathematical function", "polynomial",
                      "exponential function", "logarithmic function",
                      "trigonometric", "sine curve", "cosine curve",
                      "parametric curve", "parametric plot", "implicit curve",
                      "bezier curve", "spline interpolation",
                      "taylor series", "fourier series"],
    "3d": ["3d plot", "3d chart", "surface plot", "wireframe", "3d scatter",
           "3d bar", "3d surface", "mesh plot", "wireframe plot"],
    "signal": ["signal plot", "waveform", "oscillation", "frequency spectrum",
               "fft", "spectrogram", "impulse response", "wave plot",
               "amplitude", "phase plot"],
    "polar": ["polar plot", "polar chart", "polar coordinate",
              "rose plot", "rose chart", "angular plot"],
    "ternary": ["ternary plot", "ternary diagram", "ternary chart",
                "triangle plot", "simplex plot", "barycentric"],
    "contour": ["contour plot", "contour chart", "contour map",
                "level curve", "isoline", "topographic"],

    # ── structural fine categories ──
    ...
    "treemap": ["treemap", "tree map", "sunburst", "icicle chart",
                "partition plot"],
    "network": ["network graph", "network diagram", "neural network",
                "network topology", "dependency graph"],

    # ── compositional fine categories ──
    "table": ["table", "tabular", "spreadsheet", "data table"],
